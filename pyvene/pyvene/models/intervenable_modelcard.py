...
from .internvl.modelings_intervenable_internvl import *
...
from .internvl.modelings_intervenable_internvl import *
from .molmo.modelings_intervenable_molmo import *
from .llava_onevision.modelings_intervenable_llava_onevision import *
...
enable_molmo = True
try:
    from .molmo.modelings_molmo import MolmoWrapper
except:
    print("Failed to import molmo model, skipping.")
    enable_molmo = False
...
type_to_module_mapping = {
    ...
    hf_models.internvl.modeling_internvl.InternVLForConditionalGeneration: internvl_type_to_module_mapping,
    hf_models.llava_onevision.modeling_llava_onevision.LlavaOnevisionForConditionalGeneration: llava_onevision_type_to_module_mapping,
}
if enable_blip:
...
if enable_molmo:
    type_to_module_mapping[MolmoWrapper] = molmo_type_to_module_mapping
...
type_to_dimension_mapping = {
    ...
    hf_models.internvl.modeling_internvl.InternVLForConditionalGeneration: internvl_type_to_dimension_mapping,
    hf_models.llava_onevision.modeling_llava_onevision.LlavaOnevisionForConditionalGeneration: llava_onevision_type_to_dimension_mapping,
}
...
if enable_molmo:
    type_to_dimension_mapping[MolmoWrapper] = molmo_type_to_dimension_mapping
#########################################################################
